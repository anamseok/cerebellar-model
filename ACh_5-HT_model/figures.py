...
##########################################################################
def main():
    controlnorm, seronorm, achnorm, max_ach, \
    control, ach, \
    unique, counts, \
    int_g_e, int_g_i, \
    reduce_tonic = run_analysis()

    plot_spike_prob(controlnorm, seronorm, achnorm, max_ach, control, ach)
...
def run_analysis():
    ...
    return controlnorm, seronorm, achnorm, max_ach, \
           control, ach, \
           unique, counts, \
           int_g_e, int_g_i, \
           reduce_tonic
...
########################################################
def plot_spike_prob(controlnorm, seronorm, achnorm, max_ach, control, ach):
